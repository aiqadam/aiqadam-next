...
export const ru = {
  ...
  // Временная/предварительная формулировка (REQ-039, дизайн §3.2/§4/§6) --
  // окончательный текст утверждает владелец продукта/CONTENT-BA.
  companion: {
    fieldsPrompt:
      "Ответьте на это сообщение в формате Имя | Компания | Телефон, чтобы завершить регистрацию на {event}.",
    missingName: "Требуется имя. Пожалуйста, ответьте ещё раз в формате Имя | Компания | Телефон.",
    missingPhone: "Требуется номер телефона. Пожалуйста, ответьте ещё раз в формате Имя | Компания | Телефон.",
    confirmStatement: "Подтверждая, вы соглашаетесь на хранение этих данных для этой регистрации.",
    staleMessage: "Это подтверждение больше не действительно. Пожалуйста, откройте ссылку-приглашение заново.",
    confirmButtonLabel: "Подтвердить и зарегистрироваться",
    cancelButtonLabel: "Отмена",
    cancelled: "Отменено -- ничего не сохранено.",
